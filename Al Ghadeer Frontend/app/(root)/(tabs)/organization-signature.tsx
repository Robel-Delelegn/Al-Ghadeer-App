...
type SignatureCanvasComponent =
  typeof import("react-native-signature-canvas").default;
...
const getSignatureCanvasComponent = (): SignatureCanvasComponent | null => {
  ...
  try {
    ...
    signatureCanvasComponent = require("react-native-signature-canvas")
      .default as SignatureCanvasComponent;
  } catch (error) {
    signatureCanvasComponent = null;
    console.error(
      "react-native-signature-canvas is unavailable in this build:",
      error,
    );
  }
...
const OrganizationSignature: React.FC = () => {
  ...
  const handleConfirm = useCallback(async () => {
    ...
    try {
      ...
      const parseResult =
        await parseApiResponseOrRawWithSoftError<DriverHistoryDetail>(response);
      if (!parseResult.ok) {
        console.error(
          "[delivery-confirm-signature] failed response",
          parseResult.error,
        );
        ...
        >
                    ...
                    <View style={styles.otherActionRow}>
                      ...
                      <View style={styles.otherActionRight}>
                        <View style={styles.rentQtyControl}>
                          <TouchableOpacity
                            style={[
                              styles.rentQtyButton,
                              quantity === 0 && styles.rentQtyButtonDisabled,
                            ]}
                            onPress={() =>
          ...
          <View style={styles.signatureCard}>
            ...
            <Text style={styles.signatureHint}>
              I acknowledge receipt of the above items and agree to pay the
              amount due.
            </Text>
            ...
            {!isSignatureModuleAvailable ? (
              <View style={styles.signatureUnavailable}>
                ...
                <Text style={styles.signatureUnavailableTitle}>
                  Signature is unavailable in this build
                </Text>
                <Text style={styles.signatureUnavailableText}>
                  Rebuild and reinstall the Android app to load the required
              ...
              >
                <View style={styles.signaturePreviewContent}>
                  {signatureData ? (
                    <Image
                      source={{
                        uri: signatureData.startsWith("data:image")
                          ? signatureData
                  ...
                  <View style={styles.signatureEditBadge}>
                    ...
                    <Text style={styles.signatureEditBadgeText}>
                      Tap to edit
                    </Text>
                  </View>
                </View>
          ...
          <View style={styles.actionSection}>
            <TouchableOpacity
              style={[
                ...
                (!hasSignature || !receiverName.trim() || isProcessing) &&
          ...
          <View style={styles.modalFooter}>
            ...
            <TouchableOpacity
              style={[
                ...
                (!hasDrawnSignature || !isSignatureModuleAvailable) &&
            ...
            >
              <Text
                style={[
                  ...
                  (!hasDrawnSignature || !isSignatureModuleAvailable) &&
                    styles.modalDoneButtonTextDisabled,
                ]}
              >
                Done
              </Text>
